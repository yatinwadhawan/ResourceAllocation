...
public class BeliefSparseSampling extends MDPSolver implements Planner,
	 ...
	 *            the Belief MDP
	 *            {@link burlap.statehashing.HashableStateFactory} that
	 *            {@link burlap.behavior.singleagent.planning.stochastic.sparsesampling.SparseSampling}
	 *            will use.
	 * @param h
	 *            the height of the
	 ...
	 *            dynamics.
	 */
	public BeliefSparseSampling(PODomain domain, double discount,
		...
		this.mdpPlanner = new SparseSampling(this.beliefMDP, discount,
				hashingFactory, h, Math.max(1, c));
		if (c < 1) {
