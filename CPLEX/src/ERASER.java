...
public class ERASER {
	...
	public static void solve() throws IloException {
		int targets = 5;
		double Z = 9999;
		double B = 3; // Budget: number of hours defender has.
		...
		for (int t = 0; t < targets; t++) {
			defCov[t] = randomNumberInRange(0, 50);
			attUCov[t] = randomNumberInRange(0, 50);
			defUCov[t] = randomNumberInRange(-50, 0);
			attCov[t] = randomNumberInRange(-50, 0);
